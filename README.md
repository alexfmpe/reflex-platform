...
Docs
----
If you've already set up nix, haddock documentation for the versions pinned by your reflex-plaftorm checkout can be found by running
```bash
$ ./scripts/docs-for reflex
$ ./scripts/docs-for reflex-dom-core```
